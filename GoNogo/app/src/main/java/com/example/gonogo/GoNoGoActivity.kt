...
class GoNoGoActivity : AppCompatActivity() {
    ...
    private var STD_SCORE = 30 // number of buttons to click in Standard mode
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mTask = TaskItem(0, Date().toString(), ArrayList<Boolean>(), ArrayList<Boolean>(), ArrayList<Double>(), false, (goMode == "Standard"))
