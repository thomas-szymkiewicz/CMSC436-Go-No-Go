...
class TaskItem {
    ...
    internal constructor(num: Int, date: String, types: ArrayList<Boolean>, responses: ArrayList<Boolean>, times: ArrayList<Double>, new: Boolean) {
        this.num = num
        this.date = date
        this.types = types
    ...
    override fun toString(): String {
        return (num.toString() + ITEM_SEP + date + ITEM_SEP + types.toString() + ITEM_SEP + responses.toString() + ITEM_SEP + times.toString())
    }
